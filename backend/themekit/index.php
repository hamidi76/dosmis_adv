...
<html>
<head>
	<title>Themewagon Live Demo | Themekit-Free Bootstrap 4 HTML5 admin dashboard template</title>

	<!-- Mobile Specific -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	<link rel="stylesheet" type="text/css" href="https://themewagon.com/wp-content/themes/wagoncore/css/demo.css">
...
<div id="switcher">
		<div class="center">
            <div class="logo">
                ...
                <ul class="links">
                    <li class="download">
                    	<a href="https://themewagon.com/themes/free-bootstrap-4-html5-admin-dashboard-template-themekit/">
                    		<img src="https://themewagon.com/wp-content/themes/wagoncore/img/download.png" alt=""/>
                    		Download
                    	</a>
                    </li>
                    <li class="close">
                    	<a href="http://themekit.lavalite.org/demo/index.html">
                    		<img src="https://themewagon.com/wp-content/themes/wagoncore/img/cross.png" alt="" />
                    		Close
                    	</a>
                    </li>
                </ul>
    ...
    <iframe id="iframe" src="https://themekit.lavalite.org/demo/index.html" frameborder="0" width="100%"></iframe>
