...
use backend\assets\Dashtkv2Asset;
    ...
    <div class="page-wrap">
                ...
                <div class="nav-container">
                    <nav id="main-menu-navigation" class="navigation-main">
                        ...
                        <div class="nav-item active">
                            ...
                            <?= Html::a('<i class="ik ik-bar-chart-2"></i> <span>Dashboard</span>',['index.html']) ?>
                        </div>
                        <div class="nav-item">
                            <!--                            <a href="pages/navbar.html"> <i class="ik ik-menu"></i> <span>Navigation</span>  <span class="badge badge-success">New</span></a>-->
                            <!--                       <?//= Html::a('<i class="ik ik-menu"></i> Sign Up',['pages/navbar.html'], ['class' => 'badge badge-success', 'title' => 'Navigation']) ?> -->

                            <?= Html::a('<i class="ik ik-menu"></i> <span>Navigation</span> <h5><span class="badge badge-danger">New</span></h5>',['/cuba/index']) ?>

                        </div>
                        <div class="nav-item has-sub">
                            <!--                            <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Widgets</span> <span class="badge badge-danger">150+</span></a>-->
                            <?= Html::a('<i class="ik ik-layers"></i> <span>Widgets</span> <h5><span class="badge badge-danger">150+</span></h5>') ?>
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <?= Html::a('<i class="ik ik-box"></i> <span>Basic</span>') ?>
                            <div class="submenu-content">
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <?= Html::a('<i class="ik ik-gitlab"></i> <span>Advance</span> <h5><span class="badge badge-success">New</span></h5>') ?>
                            <div class="submenu-content">
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <?= Html::a('<i class="ik ik-package"></i> <span>Extra</span>') ?>
                            <div class="submenu-content">
                        ...
                        <div class="nav-item">
                            ...
                            <?= Html::a('<i class="ik ik-command"></i> <span>Icons</span>',['pages/ui/icons.html']) ?>
                        </div>
                        <div class="nav-lavel">Forms</div>
                        <div class="nav-item has-sub">
                            <!--                            <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>-->
                            <?= Html::a('<i class="ik ik-edit"></i> <span>Forms</span>') ?>
                            <div class="submenu-content">
                        ...
                        <div class="nav-item">
                            ...
                            <?= Html::a('<i class="ik ik-terminal"></i> <span>Form Picker</span> <h5><span class="badge badge-success">New</span></h5>','[pages/form-picker.html]') ?>
                        </div>

                        <div class="nav-lavel">Tables</div>
                        <div class="nav-item">
                            <!--                            <a href="pages/table-bootstrap.html"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>-->
                            <?= Html::a('<i class="ik ik-credit-card"></i> <span>Bootstrap Table</span>',['pages/table-bootstrap.html']) ?>
                        </div>
                        <div class="nav-item">
                            <!--                            <a href="pages/table-datatable.html"><i class="ik ik-inbox"></i><span>Data Table</span></a>-->
                            <?= Html::a('<i class="ik ik-inbox"></i> <span>Data Table</span>',['pages/table-datatable.html']) ?>
                        </div>
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <?= Html::a('<i class="ik ik-pie-chart"></i> <span>Charts</span> <h5><span class="badge badge-success">New</span></h5>') ?>
                            <div class="submenu-content">
        ...
        <footer class="footer">
            <div class="w-100 clearfix">
                <span class="text-center text-sm-left d-md-inline-block">Copyright © 2018 BPM-DOSM All Rights Reserved.</span>
